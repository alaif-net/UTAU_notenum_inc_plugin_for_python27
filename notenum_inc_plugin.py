...
#状態
STATE_WAIT_SECTION = state_wait_section_proc           #セクション開始待ち
STATE_WAIT_NOTENO_ENTRY = state_wait_noteno_entry_proc #NoteNumエントリー待ち

#最初の状態を「セクション開始待ち」に設定
state_func = STATE_WAIT_SECTION
...
if __name__ == "__main__":
	...
	for line in file_input:
		#読み込んだ行を処理
		state_func = state_func(line, file_output)
